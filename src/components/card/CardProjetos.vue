<template>
  <div class="shadow-sm sm:rounded-none h-fit w-[90%] max-w-md flex-shrink-0 sm:rounded-t-lg rounded-lg shadow-black">
    ...
    <div class="relative rounded-lg">
      <router-link :to="`projeto/${id}`">
        ...
        <img :src="img"
          class="rounded-b-lg w-full max-w-md flex-shrink-0 sm:rounded-none sm:shadow-none"
          alt="">
    </div>
