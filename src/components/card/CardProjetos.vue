<template>
  <div class="slider-inner shadow-sm sm:rounded-none h-fit touch-pan-x sm:rounded-t-lg rounded-lg shadow-black">
    ...
    <div class="relative rounded-lg">
      <!-- <router-link :to="`projeto/${id}`">
        ...
        <img :src="img"
          class=" sm:w-[310px] sm:h-[200px] rounded-b-lg max-w-sm flex-shrink-0 sm:rounded-none sm:shadow-none"
          alt="">
    </div>
